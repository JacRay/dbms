...
CREATE TABLE PURCHASE (
  ...
  orderdate DATE,
  FOREIGN KEY (custno) REFERENCES CUSTOMER(cust_no) ON UPDATE CASCADE,
  FOREIGN KEY (prono) REFERENCES PRODUCT(product_no) ON UPDATE CASCADE);
-- insert
...
-- 12
INSERT INTO PRODUCT VALUES ('P00008', 'Laptop Charger', 'HCL', 1690);
UPDATE PURCHASE SET prono = 'P00008' WHERE custno = 'C00003';
-- 13
SELECT COUNT(*) as cust_count FROM CUSTOMER  WHERE city="Delhi";
-- 14
SELECT custno,quantity FROM PURCHASE  WHERE quantity > 3;
-- 15
ALTER TABLE PURCHASE MODIFY orderdate VARCHAR(18);
-- 16
